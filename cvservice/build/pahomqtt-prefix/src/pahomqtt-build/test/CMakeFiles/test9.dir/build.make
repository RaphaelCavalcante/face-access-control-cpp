...
test/CMakeFiles/test9.dir/test9.c.o: /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/paho-src/test/test9.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object test/CMakeFiles/test9.dir/test9.c.o"
	cd /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test9.dir/test9.c.o   -c /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/paho-src/test/test9.c
...
test/CMakeFiles/test9.dir/test9.c.i: cmake_force
	...
	cd /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/paho-src/test/test9.c > CMakeFiles/test9.dir/test9.c.i
...
test/CMakeFiles/test9.dir/test9.c.s: cmake_force
	...
	cd /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/paho-src/test/test9.c -o CMakeFiles/test9.dir/test9.c.s
...
test/test9: test/CMakeFiles/test9.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable test9"
	cd /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test9.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/test9.dir/clean:
	cd /mnt/data/Projects/prototype/face-access-control-cpp/cvservice/build/pahomqtt-prefix/src/pahomqtt-build/test && $(CMAKE_COMMAND) -P CMakeFiles/test9.dir/cmake_clean.cmake
